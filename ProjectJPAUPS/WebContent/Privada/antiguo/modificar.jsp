...
<link rel="stylesheet"
	href="/ProjectJPAUPS/config/styles/stylesRMTelf.css">
	...
	<div id="header">
		...
		<div class="top">
			...
			<nav id="nav">
				<ul>
					<li><a
						href="/ProjectJPAUPS/IndexController?id=2&idU=${p2.cedula}"
			...
			<div class="container">
				...
				<div class="contenido">
					<div class="contenedor">
						<form action="/ProjectJPAUPS/EditarContacto" method="POST"
