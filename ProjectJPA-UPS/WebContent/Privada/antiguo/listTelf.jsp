		...
		<div class="top">
			...
			<div id="logo">
				<span class="image avatar48"><img
					src="/ProjectJPAUPS/config/images/avatar.jpg" alt="" /></span>
			...
			<nav id="nav">
				<ul>
					<li><a href="/ProjectJPAUPS/IndexController?id=2&idU=${p2.cedula}" id="contact-link"><span
							class="icon solid fa-envelope">Contactos</span></a></li>
					<li><a href="/ProjectJPAUPS/CerrarSesion" id="top-link"><span
		...
		<section id="contact" class="four">
			<div class="container">
				<div class="container mt-3">
					...
					<form action="/ProjectJPAUPS/Buscar?id=3&idU=${p2.cedula}" method="POST">
					...
					<form action="/ProjectJPAUPS/Buscar?id=4&idU=${p2.cedula}" method="POST">
						<div class="input-group mb-3 input-group-sm">
							<div class="input-group-prepend">
